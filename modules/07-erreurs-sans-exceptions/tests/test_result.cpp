...
//  Status
// =============================================================================
TEST_REQ(Status, label_for_each_value, "LLR-M07-001") {
...
//  Result<T>
// =============================================================================
TEST_REQ(Result, default_is_an_error, "LLR-M07-010") {
...
TEST_REQ(Result, success, "LLR-M07-011") {
...
TEST_REQ(Result, error, "LLR-M07-012") {
...
TEST_REQ(Result, error_ok_is_neutralized, "LLR-M07-013") {
...
TEST_REQ(Result, access_value_on_error_is_reported, "LLR-M07-014") {
...
//  StatusCounters
// =============================================================================
TEST_REQ(Counters, counting_and_dominant_cause, "LLR-M07-020") {
...
TEST_REQ(Counters, initial_state_and_reset, "LLR-M07-021") {
    mod07::StatusCounters counters;
    counters.reset();
...
TEST_REQ(Counters, robustness_status_outside_enumeration, "LLR-M07-022") {
    mod07::StatusCounters counters;
    counters.reset();
...
//  ARINC 429
// =============================================================================
TEST_REQ(Arinc, odd_parity, "LLR-M07-030") {
...
TEST_REQ(Arinc, encoding_then_decoding, "LLR-M07-031") {
...
TEST_REQ(Arinc, negative_value_twos_complement, "LLR-M07-032") {
...
TEST_REQ(Arinc, robustness_altered_parity, "LLR-M07-033") {
...
TEST_REQ(Arinc, robustness_unhandled_label, "LLR-M07-034") {
...
TEST_REQ(Arinc, ssm_source_fault, "LLR-M07-035") {
...
TEST_REQ(Arinc, ssm_data_unavailable, "LLR-M07-036") {
...
// -----------------------------------------------------------------------------
TEST_REQ(Chaining, nominal_altitude, "LLR-M07-040") {
...
TEST_REQ(Chaining, parity_error_propagation, "LLR-M07-041") {
...
TEST_REQ(Chaining, bad_label, "LLR-M07-042") {
...
TEST_REQ(Chaining, value_out_of_flight_domain, "LLR-M07-043") {
...
TEST_REQ(Chaining, flight_domain_bounds, "LLR-M07-044") {
    const u32 ceiling =
