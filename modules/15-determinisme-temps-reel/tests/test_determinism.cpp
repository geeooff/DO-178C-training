...
// =============================================================================
TEST_REQ(Float, absorption_beyond_two_pow_24, "LLR-DET-010") {
...
TEST_REQ(Float, absorption_at_small_scale, "LLR-DET-010") {
...
TEST_REQ(Float, ulp_grows_with_magnitude, "LLR-DET-011") {
    // 2^-23 = 1,1920929e-7
...
TEST_REQ(Float, addition_not_associative, "LLR-DET-012") {
    // (1 + (-1)) + 1e-8 = 1e-8
...
TEST_REQ(Float, accumulation_drift, "LLR-DET-013") {
...
TEST_REQ(Float, kahan_sum_bounds_drift, "LLR-DET-014") {
...
TEST_REQ(Float, absolute_and_relative_tolerance, "LLR-DET-020,LLR-DET-021") {
...
TEST_REQ(Float, robustness_of_comparisons, "LLR-DET-020,LLR-DET-021") {
...
//  2. Virgule fixe
// =============================================================================
TEST_REQ(FixedPoint, representation, "LLR-FIX-010,LLR-FIX-012") {
...
TEST_REQ(FixedPoint, truncation_toward_negative_infinity, "LLR-FIX-012") {
...
TEST_REQ(FixedPoint, bounded_float_conversion, "LLR-FIX-011") {
...
TEST_REQ(FixedPoint, robustness_non_finite, "LLR-FIX-011") {
...
TEST_REQ(FixedPoint, exact_arithmetic, "LLR-FIX-020,LLR-FIX-021,LLR-FIX-022") {
...
TEST_REQ(FixedPoint, saturation, "LLR-FIX-020,LLR-FIX-021") {
...
TEST_REQ(FixedPoint, division, "LLR-FIX-023") {
    Fixed result;
...
TEST_REQ(FixedPoint, predictable_drift, "LLR-FIX-030") {
...
TEST_REQ(Scheduling, valid_plan, "LLR-SCH-010,LLR-SCH-011") {
...
TEST_REQ(Scheduling, overlap_rejected, "LLR-SCH-010") {
...
TEST_REQ(Scheduling, window_out_of_period_rejected, "LLR-SCH-010") {
    MajorFrame frame(10000U);
...
TEST_REQ(Scheduling, degenerate_window_rejected, "LLR-SCH-010") {
    MajorFrame frame(10000U);
...
TEST_REQ(Scheduling, bounded_capacity, "LLR-SCH-010") {
...
TEST_REQ(Scheduling, time_margin, "LLR-SCH-012") {
    const MajorFrame frame = reference_frame();
...
TEST_REQ(Scheduling, nominal_execution, "LLR-SCH-020") {
    const MajorFrame frame = reference_frame();
...
TEST_REQ(Scheduling, overrun_detected_and_localized, "LLR-SCH-020") {
    const MajorFrame frame = reference_frame();
...
TEST_REQ(Scheduling, several_overruns, "LLR-SCH-020") {
    const MajorFrame frame = reference_frame();
...
TEST_REQ(Scheduling, robustness_inputs, "LLR-SCH-020") {
    const MajorFrame frame = reference_frame();
...
// =============================================================================
TEST_REQ(Register, successful_wait, "LLR-DET-030") {
...
TEST_REQ(Register, bounded_wait_on_fault, "LLR-DET-030") {
...
TEST_REQ(Register, robustness_zero_mask, "LLR-DET-030") {
    mod15::SimulatedRegister hw_register;
...
TEST_REQ(Register, write_then_readback, "LLR-DET-030") {
    mod15::SimulatedRegister hw_register;
